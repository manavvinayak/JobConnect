export function Footer() {
  return (
    <footer className="bg-gray-800 text-gray-300 py-10 px-6 md:px-10">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h3 className="text-lg font-bold text-white mb-4">GetConnect</h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a href="/find-talent" className="hover:text-white transition-colors">
                How to Hire
              </a>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a href="/find-work" className="hover:text-white transition-colors">
                How to Get Work
              </a>
            </li>
            <li>
